...
public:
	...
	virtual void registerView(hdDrawingView *view) {usedView = view;};
	virtual hdDrawingView* getView() {return usedView;};
	...
	hdCollection* selectedFigures() {return selection;};
	hdCollection* getFiguresCollection() {return figures;};
	hdDrawingEditor* getOwnerEditor() {return ownerEditor;};
